...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omnifood is a premium food delivery with the mission to bring affordable and healty meals to as many people as possible.">
    ...
    <body>
        ...
        <header>
            ...
            <div class="hero-text-box">
                ...
                <a class="btn btn-full make-same-size-hungry-btn js--scroll-to-plans" href="#">I'm hungry</a>
                <a class="btn btn-ghost make-same-size-more-btn js--scroll-to-start" href="#">Show me more</a>
            </div>
        </header>
